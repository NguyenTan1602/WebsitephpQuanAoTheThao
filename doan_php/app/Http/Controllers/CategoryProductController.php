...
class CategoryProductController extends Controller
{
	...
	public function view_category_product(){
		//return view('admin.view_category_product');
		$all_category_product=DB::table('tb1_category_product') ->get();
		$manage_category_product=view('admin.view_category_product')->width('admin.view_category_product',$all_category_product);
		return view('admin_layout')->width('admin.view_category_product',$manage_category_product);
	}
	
	public function save_category_product(){
          $data =array();
          $data['category_name']=$request->catgory_product_name;
          $data['category_describe'] = $request->category_product_describe;

          $result = DB::table('message','Bạn đã thêm loại sản phẩm thành công !');
