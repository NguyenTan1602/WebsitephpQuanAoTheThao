...
Route::get('/LuaSP' ,'CategoryProductController@save_category_product');

Route::get('/SuaSP' ,'CategoryProductController@edit_category_product');
Route::get('/XoaSP' ,'CategoryProductController@delete_category_product');
