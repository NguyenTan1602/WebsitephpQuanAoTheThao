                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">QUÊN PASSWORD</h3></div>
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="{{URL::to('admin/login')}}">Quay lại trang Login</a>
                                                <a class="btn btn-primary" href="{{URL::to('admin/password')}}">Reset Password</a>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="{{URL::to('admin/register')}}>Cần một tài khoản mới? Đăng ký!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
