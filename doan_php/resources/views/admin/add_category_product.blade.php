                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{URL::to('/LuuSP')}}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea style="resize: none; size: 5  " class="form-control py-4" id="inputEmailAddress" type="text" placeholder="Nhập mô tả " name="category_product_describle"></textarea>
                                                </div>
