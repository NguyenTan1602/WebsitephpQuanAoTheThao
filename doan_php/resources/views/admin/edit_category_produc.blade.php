                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Sửa sách</h3></div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{URL::to('CapNhatSP/'.$edit_value->category_id)}}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea style="resize: none; size: 5" class="form-control py-4" id="inputEmailAddress" type="text"  name="category_product_describe" >
