...
<html lang="en">
    <head>
        ...
        <title>Quản lý Shop Bán Quần áo thể thao</title>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="sb-sidenav-menu-heading">SLAM DUNK Shop</div>
                            <a class="nav-link" href="{{URL::to('admin')}}">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Quản Lý Shop Bán Quần áo thể thao
                            </a>                          
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                   <a class="nav-link" href="#">Thể thao nam</a>
                                    <a class="nav-link" href="#">Thể thao nữ</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">                
                 <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">BIỂU ĐỒ THỐNG KÊ DOANH SỐ</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="admin.html">Trang chủ Admin</a></li>
                            <li class="breadcrumb-item active">Biểu đồ Thống kê doanh số</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                Chart.js là một plugin của bên thứ ba được sử dụng để tạo các biểu đồ trong mẫu này. Các biểu đồ bên dưới đã được tùy chỉnh - để có thêm các tùy chọn tùy chỉnh, vui lòng truy cập trang chính thức
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Thống kê sản phẩm bán chạy trong quý theo dạng điểm
                            </div>
                            <div class="card-body"><canvas id="myAreaChart" width="100%" height="30"></canvas></div>
                            <div class="card-footer small text-muted">Giá trị được cập nhật vào lúc 21:00 PM </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        Thống kê sản phẩm bán chạy trong quý theo dạng Bar chart 
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        Thống kê sản phẩm bán chạy trong quý theo dạng Pie Chart
                                    </div>
